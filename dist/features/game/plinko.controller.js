...
exports.getPlinkoConfig = exports.dropPlinko = void 0;
...
const dropPlinko = async (req, res) => {
    try {
        if (!req.user) {
        ...
        for (let r = 0; r < ROWS; r++) {
            path.push(crypto_1.default.randomInt(0, 2)); // 0 or 1
        }
...
exports.dropPlinko = dropPlinko;
const getPlinkoConfig = (_req, res) => {
    res.json({
        success: true,
        rows: ROWS,
...
exports.getPlinkoConfig = getPlinkoConfig;
