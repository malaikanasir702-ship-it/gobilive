...
exports.handleAppealDecision = exports.deleteReelByAdmin = exports.listReels = void 0;
...
exports.deleteReelByAdmin = deleteReelByAdmin;
// POST /api/admin/reels/:id/appeal-decision — Approve (restore) or Reject appeal
const handleAppealDecision = async (req, res) => {
    try {
...
exports.handleAppealDecision = handleAppealDecision;
