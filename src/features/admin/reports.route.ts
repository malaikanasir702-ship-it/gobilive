...
import { listReports, getReport, dismissReport, escalateReport, bulkDismissReports } from './reports.controller';
...
router.post('/bulk-dismiss', ACTION_GUARD, bulkDismissReports as any);
