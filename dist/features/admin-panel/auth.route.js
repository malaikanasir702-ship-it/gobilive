...
const admin_auth_controller_2 = require("../admin/admin-auth.controller");
...
router.post('/forgot-password', admin_auth_controller_2.adminForgotPassword);
router.post('/reset-password', admin_auth_controller_2.adminVerifyOtpReset);
