...
exports.TIKTOK_GIFTS_SEED = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const path_1 = __importDefault(require("path"));
dotenv_1.default.config({ path: path_1.default.resolve(__dirname, '../../.env') });
const mongoose_1 = __importDefault(require("mongoose"));
const gift_model_1 = require("../features/gifts/gift.model");
exports.TIKTOK_GIFTS_SEED = [
...
async function main() {
    ...
    for (const giftData of exports.TIKTOK_GIFTS_SEED) {
        await gift_model_1.Gift.updateOne({ id: giftData.id }, {
            $set: {
                ...giftData,
                isVipOnly: false,
                animation: 'float',
    ...
    console.log(`✅  Seeded ${exports.TIKTOK_GIFTS_SEED.length} TikTok gifts. Total catalog count: ${count}`);
