...
app.post('/api/forgot-password', auth_controller_1.forgotPassword);
app.post('/api/forgot_password', auth_controller_1.forgotPassword);
app.post('/api/reset-password', auth_controller_1.resetPassword);
app.post('/api/reset_password', auth_controller_1.resetPassword);
// Find My Account fallback routes (also available under /api/auth/*)
app.post('/api/find-account', auth_controller_1.findMyAccount);
app.post('/api/send-recovery-otp', auth_controller_1.sendAccountRecoveryOtp);
app.post('/api/verify-otp-reset', auth_controller_1.verifyOtpAndResetPassword);
